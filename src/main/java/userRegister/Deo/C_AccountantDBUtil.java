...
public class C_AccountantDBUtil {
	...
	public static boolean tvseriesinsert(String e_Name, String e_Code, String t_Cost, String e_dis, String a_Dicession) {
		...
		try {
			...
			String sql = "insert into onlineeventmngsystwm.bill values('"+e_Name+"','"+e_Code+"','"+t_Cost+"','"+e_dis+"','"+a_Dicession+"')";
	...
	public static boolean updatetvseries(String e_Name, String e_Code, String t_Cost, String e_dis, String a_Dicession) {
		String url = "jdbc:mysql://127.0.0.1:3306/onlineeventmngsystwm";
		String user = "root";
		String pass = "Linuka@2002";
		
		try {
			Class.forName("com.mysql.jdbc.Driver");
			Connection con = DriverManager.getConnection(url, user, pass);
			Statement stmt = con.createStatement();
			String sql = "SELECT * FROM onlineeventmngsystwm.bill WHERE e_Name = '"+e_Name+"'";
	...
	String pass = "t1h2a3th";
		...
		try {
			...
			Connection con = DriverManager.getConnection(url, user, pass);
			Statement stmt = con.createStatement();
			String sql1 = "update onlineeventmngsystwm.bill set e_Code='"+e_Code+"',t_Cost='"+t_Cost+"',e_dis='"+e_dis+"',a_Dicession='"+a_Dicession+"'" 
					+ "where e_Name='"+e_Name+"'";		
	...
	public static boolean deletetvseries(String e_Name) {
		...
		try {
			...
			String sql="delete from onlineeventmngsystwm.bill where e_Name='"+e_Name+"'";
