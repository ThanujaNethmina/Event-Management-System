...
public class D_SysadminDeleteDButil {
		...
		public static boolean updateupdetails(String id,String ename,String edate,String ecode,String ecgory,String etheme,String evenue,String edescript,String eorgname,String eorgdt){
			...
			try {
				...
				String sql = "update onlineeventmngsystwm.event set ename='"+ename+"', edate='"+edate+"' , ecode='"+ecode+"' , ecgory='"+ecgory+"' , etheme='"+etheme+"' , evenue='"+evenue+"' , edescript='"+edescript+"' , eorgname='"+eorgname+"' , eorgdt='"+eorgdt+"' where id='"+id+"' ";
		...
		public static boolean deleteupdetails(String id) {
			...
			try {
				con = DBConnect.getConnection();
				stmt = con.createStatement();
				String sql = "delete from onlineeventmngsystwm.event where id='"+convId+"'";
				rs = stmt.executeUpdate(sql);
